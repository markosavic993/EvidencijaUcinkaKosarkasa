...
//    }
    ...
    private void napuniListuUtakmica() {
        ...
        List<Utakmica> lista = Kontroler.getInstance().vratiUtakmice();
        ...
        jlistUtakmice.addMouseListener(new MouseListener() {
            ...
            private void napuniListuIgraca(Utakmica izabranaUtakmica) {
                ...
                for (Kosarkas k : Kontroler.getInstance().vratiKosarkaseIzJednogTima(izabranaUtakmica.getDomacin())) {
                    dlm.addElement(k);
                }
                for (Kosarkas k : Kontroler.getInstance().vratiKosarkaseIzJednogTima(izabranaUtakmica.getGost())) {
                    dlm.addElement(k);
                }
                ...
                jcomboIgraci.addActionListener(new ActionListener() {
                    ...
                    private void unesiVrednostiUTekstualnoPolje(Utakmica u, Kosarkas k) {
                        List<Ucinak> lista = Kontroler.getInstance().vratiUcinkeOdredjenogIgracaNaUtakmici(k, u);
